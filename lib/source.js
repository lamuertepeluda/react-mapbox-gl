...
var Source = (function (_super) {
    ...
    Source.prototype.shouldComponentUpdate = function (nextProps) {
        var _a = this.props, geoJsonSource = _a.geoJsonSource, tileJsonSource = _a.tileJsonSource;
        var nextGeoJsonSource = nextProps.nextGeoJsonSource, nextTileJsonSource = nextProps.nextTileJsonSource;
    ...
    Source.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (tileJsonSource && prevProps.tileJsonSource) {
            var hasNewTilesSource = (tileJsonSource.url !== prevProps.tileJsonSource.url ||
